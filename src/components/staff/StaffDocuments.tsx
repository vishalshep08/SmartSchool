...
export function StaffDocuments() {
  return (
    <div className="space-y-4">
      <div>
        <h2 className="font-heading text-xl font-semibold">Staff Documents</h2>
        <p className="text-sm text-muted-foreground">View and manage uploaded staff documents</p>
      </div>
      <div className="glass-card p-12 text-center">
        <FolderOpen className="w-12 h-12 mx-auto text-muted-foreground mb-4" />
        <h3 className="font-heading font-semibold text-foreground mb-2">Documents are accessible via Employee Profiles</h3>
